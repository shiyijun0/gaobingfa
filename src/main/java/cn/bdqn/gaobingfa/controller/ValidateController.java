...
import cn.bdqn.gaobingfa.entity.Transaction;
import cn.bdqn.gaobingfa.validator.TransactionValidator;
...
public class ValidateController {
	...
	@RequestMapping("/validate")
	public String validate(ModelMap modelMap, Model model){
		return "validate";
	}
