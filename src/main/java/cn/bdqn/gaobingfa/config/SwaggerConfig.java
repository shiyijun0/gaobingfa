...
public class SwaggerConfig {
  ...
  private   Boolean swaggerEnabled;
    ...
    public Docket createRestApi() {
        System.out.println("************"+swaggerInfo.isEnabled());
        ...
        //.paths(PathSelectors.ant(swaggerInfo.getAntPath())).build().pathMapping("/");
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .description("程序狗")
                // 作者信息
                .contact(new Contact("shiYijun", swaggerInfo.getUrl(), "617318842@qq.com"))
                .version("1.0.0")
                .build();
    }
}
